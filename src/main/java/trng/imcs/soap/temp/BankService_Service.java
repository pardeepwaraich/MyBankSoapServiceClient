 ...
 * 
 */
@WebServiceClient(name = "BankService", targetNamespace = "http://trng.imcs.org/BankService/", wsdlLocation = "file:/C:/Manohar/workspace-imcs-training/MyBankSoapServiceClient/src/main/resources/BankService.wsdl")
    ...
    extends Service
{
    ...
    private final static QName BANKSERVICE_QNAME = new QName("http://trng.imcs.org/BankService/", "BankService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("file:/C:/Manohar/workspace-imcs-training/MyBankSoapServiceClient/src/main/resources/BankService.wsdl");
    ...
    public BankService getBankServiceSOAP() {
        return super.getPort(new QName("http://trng.imcs.org/BankService/", "BankServiceSOAP"), BankService.class);
    }
    ...
    public BankService getBankServiceSOAP(WebServiceFeature... features) {
        return super.getPort(new QName("http://trng.imcs.org/BankService/", "BankServiceSOAP"), BankService.class, features);
    }
